...
const JellyDisplay: React.FC<JellyDisplayProps> = ({
  ...
  return (
    <div
      className={`inline-flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-pink-100 to-purple-100 rounded-full border-2 border-pink-200 shadow-sm ${
        isSmall ? 'text-sm' : 'text-base'
      }`}>
      {/* 젤리 아이콘 */}
      <div className="relative">
        <div
          className={`bg-pink-400 rounded-full border-2 border-pink-600 ${
